...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/cofedish/3xui-agents/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/cofedish/3xui-agents/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    wget -O /usr/bin/x-ui https://raw.githubusercontent.com/cofedish/3xui-agents/main/x-ui.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/cofedish/3xui-agents/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/cofedish/3xui-agents/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N https://github.com/cofedish/3xui-agents/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
